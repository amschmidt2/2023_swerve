...
import frc.robot.commands.swerve.QuickLeftStrafe;
...
public class RedLeft_Cube extends SequentialCommandGroup {
    
    public RedLeft_Cube(Arm arm, IntakeArm Aintake, Compressor comp, FloorIntake Fintake, DriveSubsystem swerveDrive, Conveyor convey){
        addCommands(
            ...
            .andThen(new LongerCommunity(swerveDrive)).andThen(new QuickLeftStrafe(swerveDrive))
