...
public class ConfigMap {
    ...
    */
    ...
    public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 23; // 2 --> 23
    public static final int BACK_LEFT_MODULE_STEER_ENCODER = 21; // 6 --> 21
    public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 22; // 24 --> 22
    ...
    // off sets
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(79.277); //pos - 78.514 --> 79.277
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(52.207); // pos - 50.977 --> 52.207 new
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(17.139); // pos 17.402 --> 17.139 new
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(304.146); // pos- 247.412 --> 304.146 new
